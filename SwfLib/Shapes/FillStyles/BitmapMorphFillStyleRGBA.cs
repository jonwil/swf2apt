...
{
    public class BitmapMorphFillStyleRGBA : FillStyleRGBA
    {
        ...
        public SwfMatrix StartBitmapMatrix = SwfMatrix.Identity;
        
        public SwfMatrix EndBitmapMatrix = SwfMatrix.Identity;
