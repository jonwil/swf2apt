    ...
    public class ActionsFactory {
        ...
        public ActionBase Create(ActionCode code) {
            switch (code) {
                ...
                #region EA
                case ActionCode.PushThis:
                    return new ActionPushThis();
                case ActionCode.PushGlobal:
                    return new ActionPushGlobal();
                case ActionCode.PushZero:
                    return new ActionPushZero();
                case ActionCode.PushOne:
                    return new ActionPushOne();
                case ActionCode.CallFuncAndPop:
                    return new ActionCallFuncAndPop();
                case ActionCode.CallFuncSetVariable:
                    return new ActionCallFuncSetVariable();
                case ActionCode.CallMethodAndPop:
                    return new ActionCallMethodAndPop();
                case ActionCode.CallMethodSetVariable:
                    return new ActionCallMethodSetVariable();
                case ActionCode.PushThisVariable:
                    return new ActionPushThisVariable();
                case ActionCode.PushGlobalVariable:
                    return new ActionPushGlobalVariable();
                case ActionCode.PushZeroSetVar:
                    return new ActionPushZeroSetVar();
                case ActionCode.PushTrue:
                    return new ActionPushTrue();
                case ActionCode.PushFalse:
                    return new ActionPushFalse();
                case ActionCode.PushNULL:
                    return new ActionPushNULL();
                case ActionCode.PushUndefined:
                    return new ActionPushUndefined();
                case ActionCode.TraceStart:
                    return new ActionTraceStart();
                case ActionCode.PushString:
                    return new ActionPushString();
                case ActionCode.PushStringDictByte:
                    return new ActionPushStringDictByte();
                case ActionCode.PushStringDictWord:
                    return new ActionPushStringDictWord();
                case ActionCode.PushStringGetVariable:
                    return new ActionPushStringGetVariable();
                case ActionCode.PushStringGetMember:
                    return new ActionPushStringGetMember();
                case ActionCode.PushStringSetVariable:
                    return new ActionPushStringSetVariable();
                case ActionCode.PushStringSetMember:
                    return new ActionPushStringSetMember();
                case ActionCode.StringDictByteGetVariable:
                    return new ActionStringDictByteGetVariable();
                case ActionCode.StringDictByteGetMember:
                    return new ActionStringDictByteGetMember();
                case ActionCode.DictCallFuncAndPop:
                    return new ActionDictCallFuncAndPop();
                case ActionCode.DictCallFuncSetVariable:
                    return new ActionDictCallFuncSetVariable();
                case ActionCode.DictCallMethodAndPop:
                    return new ActionDictCallMethodAndPop();
                case ActionCode.DictCallMethodSetVariable:
                    return new ActionDictCallMethodSetVariable();
                case ActionCode.PushFloat:
                    return new ActionPushFloat();
                case ActionCode.PushByte:
                    return new ActionPushByte();
                case ActionCode.PushWord:
                    return new ActionPushWord();
                case ActionCode.PushDWord:
                    return new ActionPushDWord();
                case ActionCode.IfFalse:
                    return new ActionIfFalse();
                case ActionCode.PushRegister:
                    return new ActionPushRegister();
                #endregion
