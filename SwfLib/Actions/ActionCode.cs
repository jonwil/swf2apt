namespace SwfLib.Actions {
    ...
    public enum ActionCode : byte {
        ...
        PushOne = 0x5A,
        CallFuncAndPop = 0x5B,
        CallFuncSetVariable = 0x5C,
        CallMethodAndPop = 0x5D,
        CallMethodSetVariable = 0x5E,
        PushThisVariable = 0x70,
        PushGlobalVariable = 0x71,
        PushZeroSetVar = 0x72,
        PushTrue = 0x73,
        PushFalse = 0x74,
        PushNULL = 0x75,
        ...
        TraceStart = 0x77,
        PushString = 0xA1,
        PushStringDictByte = 0xA2,
        PushStringDictWord = 0xA3,
        PushStringGetVariable = 0xA4,
        PushStringGetMember = 0xA5,
        PushStringSetVariable = 0xA6,
        PushStringSetMember = 0xA7,
        StringDictByteGetVariable = 0xAE,
        StringDictByteGetMember = 0xAF,
        DictCallFuncAndPop = 0xB0,
        DictCallFuncSetVariable = 0xB1,
        DictCallMethodAndPop = 0xB2,
        DictCallMethodSetVariable = 0xB3,
        PushFloat = 0xB4,
        PushByte = 0xB5,
        PushWord = 0xB6,
        PushDWord = 0xB7,
