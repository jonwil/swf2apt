namespace SwfLib.Actions {
    public interface IActionVisitor<TArg, TResult> {
        ...
        /// <summary>
        /// Visits PushThis action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushThis action, TArg arg);

        /// <summary>
        /// Visits PushGlobal action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushGlobal action, TArg arg);

        /// <summary>
        /// Visits PushZero action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushZero action, TArg arg);

        /// <summary>
        /// Visits PushOne action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushOne action, TArg arg);

        /// <summary>
        /// Visits CallFuncAndPop action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionCallFuncAndPop action, TArg arg);

        /// <summary>
        /// Visits CallFuncSetVariable action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionCallFuncSetVariable action, TArg arg);

        /// <summary>
        /// Visits CallMethodAndPop action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionCallMethodAndPop action, TArg arg);

        /// <summary>
        /// Visits CallMethodSetVariable action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionCallMethodSetVariable action, TArg arg);

        /// <summary>
        /// Visits PushThisVariable action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushThisVariable action, TArg arg);

        /// <summary>
        /// Visits PushGlobalVariable action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushGlobalVariable action, TArg arg);

        /// <summary>
        /// Visits PushZeroSetVar action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushZeroSetVar action, TArg arg);

        /// <summary>
        /// Visits PushTrue action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushTrue action, TArg arg);

        /// <summary>
        /// Visits PushFalse action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushFalse action, TArg arg);

        /// <summary>
        /// Visits PushNULL action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushNULL action, TArg arg);

        /// <summary>
        /// Visits PushUndefined action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushUndefined action, TArg arg);

        /// <summary>
        /// Visits TraceStart action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionTraceStart action, TArg arg);

        /// <summary>
        /// Visits PushString action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushString action, TArg arg);

        /// <summary>
        /// Visits PushStringDictByte action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushStringDictByte action, TArg arg);

        /// <summary>
        /// Visits PushStringDictWord action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushStringDictWord action, TArg arg);

        /// <summary>
        /// Visits PushStringGetVariable action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushStringGetVariable action, TArg arg);

        /// <summary>
        /// Visits PushStringGetMember action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushStringGetMember action, TArg arg);

        /// <summary>
        /// Visits PushStringSetVariable action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushStringSetVariable action, TArg arg);

        /// <summary>
        /// Visits PushStringSetMember action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushStringSetMember action, TArg arg);

        /// <summary>
        /// Visits StringDictByteGetVariable action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionStringDictByteGetVariable action, TArg arg);

        /// <summary>
        /// Visits StringDictByteGetMember action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionStringDictByteGetMember action, TArg arg);

        /// <summary>
        /// Visits DictCallFuncAndPop action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionDictCallFuncAndPop action, TArg arg);

        /// <summary>
        /// Visits DictCallFuncSetVariable action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionDictCallFuncSetVariable action, TArg arg);

        /// <summary>
        /// Visits DictCallMethodAndPop action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionDictCallMethodAndPop action, TArg arg);

        /// <summary>
        /// Visits DictCallMethodSetVariable action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionDictCallMethodSetVariable action, TArg arg);

        /// <summary>
        /// Visits PushFloat action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushFloat action, TArg arg);

        /// <summary>
        /// Visits PushByte action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushByte action, TArg arg);

        /// <summary>
        /// Visits PushWord action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushWord action, TArg arg);

        /// <summary>
        /// Visits PushDWord action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushDWord action, TArg arg);

        /// <summary>
        /// Visits IfFalse action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionIfFalse action, TArg arg);

        /// <summary>
        /// Visits PushRegister action.
        /// </summary>
        /// <param name="action">Action to be visitied</param>
        /// <param name="arg">Additional </param>
        /// <returns></returns>
        TResult Visit(ActionPushRegister action, TArg arg);
    }
}
